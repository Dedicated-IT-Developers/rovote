        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
				    ...
				    <a class="flex-sm-fill text-sm-center nav-link"  id="orders-paid-tab" data-bs-toggle="tab" href="#orders-paid" role="tab" aria-controls="orders-paid" aria-selected="false">Qualified</a>
							    ...
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
											...
											<tr>
												<td class="cell">#</td>
												<td class="cell"><img src="" alt=""></td>
												<td class="cell">Sample Name</td>
												<td class="cell">Governor</td>
												<td class="cell"><span>III</span><span class="note">F1</span></td>
												<td class="cell">pdf,docs</td>
