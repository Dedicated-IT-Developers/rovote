						...
						<div class="app-card app-card-doc shadow-sm h-100">
							<div class="app-card-thumb-holder p-3">
								<div class="app-card-thumb">
									<img class="thumb-image" src="<?php echo BASE_URL; ?>uploads/profile/<?php echo $candidate['picture']; ?>" alt="Candidate Picture">
								</div>
							...
							<div class="app-card-body p-3 has-card-actions">
								...
								<h4 class="app-doc-title truncate mb-0"><a href="#file-link"><?php echo $candidate['full_name']; ?></a></h4>
								<div class="app-doc-meta">
									<ul class="list-unstyled mb-0">
										<li><span>Position:</span> <?php echo $candidate['position']; ?></li>
										<li><span class="text-muted">Vote:</span> <?php echo vote_count($candidate['id']); ?></li>
