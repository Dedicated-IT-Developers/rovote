                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" role="tabpanel" id="tab-1">
                                ...
                                <section class="py-4 py-xl-5 pt-0" style="text-align: right;">
                                    ...
                                    </div><a class="btn btn-primary me-5" ><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-caret-right">
                                ...
                                <section>
                                    <div class="container">
                                        ...
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="col-md-6 col-lg-5 col-xl-4">
                                                <div>
                                                    <div class="p-3 p-xl-4"><label class="form-label"><strong>Auditor</strong></label><!-- Start: Success Example -->
                                                        <div class="mb-3"><select class="form-select">
                                            ...
                                            <div class="col">
                                                <div class="p-3 p-xl-4" ><label class="form-label"><strong>Board Member</strong></label><!-- Start: Success Example -->
                                                    <div class="mb-3"><select class="form-select">
                                                            <optgroup label="Board Member">
                                                                <?php candidates('Board Member'); ?>
                                                            </optgroup>
                                                ...
                                                <div class="text-end"><a class="btn btn-primary" ><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-arrow-right-circle-fill">
